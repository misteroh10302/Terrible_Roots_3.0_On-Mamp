<footer class="content-info homepage_footer" role="contentinfo">
  <div class="container footer_container">
    <div class="row">
        <div class="col-md-offset-1 col-md-3 social_footer">
                 <p class="link">
        ...
        <a href="http://localhost:8888/wordpress/homepage/">
